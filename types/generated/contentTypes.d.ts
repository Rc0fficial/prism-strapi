...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formId: Schema.Attribute.UID<'title'>;
...
export interface ApiGoalGoal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status_check: Schema.Attribute.Enumeration<
...
export interface ApiMeetingMeeting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    join_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::meeting.meeting'
...
export interface ApiUserFormpUserFormp extends Struct.CollectionTypeSchema {
  collectionName: 'user_formps';
  info: {
    description: '';
    displayName: 'user_form';
    pluralName: 'user-formps';
    singularName: 'user-formp';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    form: Schema.Attribute.Relation<'oneToMany', 'api::form.form'>;
    isCompleted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-formp.user-formp'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWeekContentWeekContent extends Struct.CollectionTypeSchema {
  collectionName: 'week_contents';
  info: {
    description: '';
    displayName: 'Week';
    pluralName: 'week-contents';
    singularName: 'week-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    week_status: Schema.Attribute.Enumeration<['closed', 'open', 'upcoming']>;
    weekId: Schema.Attribute.UID & Schema.Attribute.Required;
  };
}
